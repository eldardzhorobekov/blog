...
urlpatterns = [
     ...
     path('profile/<username>/get_followers', views.ProfileFollowersView.as_view(), name='profile-get-followers'),
     path('profile/<username>/get_following', views.ProfileFollowingView.as_view(), name='profile-get-following'),
